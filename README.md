# errores
- [new] En la parte de las Shared Collections, no se puede acceder mediante el paginado a la página 13 en adelante debido al siguiente error: "Executor error: OperationFailed: Sort operation used more than the maximum 33554432 bytes of RAM. Add an index, or specify a smaller limit. (17144) "
